...
export default function LabelUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setLabels(cleanValues.labels ?? []);
    setCurrentLabelsValue(false);
    setErrors({});
  };
  ...
  const [currentLabelsValue, setCurrentLabelsValue] = React.useState(false);
